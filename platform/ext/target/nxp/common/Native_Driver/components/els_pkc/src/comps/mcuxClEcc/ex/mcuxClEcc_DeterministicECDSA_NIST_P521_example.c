...
/**
 * @file  mcuxClEcc_DeterministicECDSA_NIST_P521_example.c
 * @brief Example for the mcuxClEcc component
 *
 * @example mcuxClEcc_DeterministicECDSA_NIST_P521_example.c
...
MCUXCLEXAMPLE_FUNCTION(mcuxClEcc_DeterministicECDSA_NIST_P521_example)
{
    /******************************************/
    ...
    MCUXCLEXAMPLE_ALLOCATE_AND_INITIALIZE_SESSION(sessionHandle, MCUXCLECC_SIGN_DETERMINISTIC_ECDSA_WACPU_SIZE, MCUXCLECC_SIGN_WAPKC_SIZE_640);
